#include "conio.h"
// conio.h is short for console input/output that is useful but not part of the standard C .
...
// 0 means the current termios , 0 is the file identifier .
